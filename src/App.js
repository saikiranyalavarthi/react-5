...
function App() {
  return (
    <div className="App">
<p><b style={{color:"black"}}>1.High Order Component in react js ?</b></p>
...
<p><b style={{color:"black"}}>2.Do you know about SEO ? Is it true that react js supports SEO support</b></p>
...
<p><b style={{color:"black"}}>3.clean up in useEffect</b></p>
...
<p><b style={{color:"black"}}>4.What is the use of useCallback and useMemo</b></p>
...
<b style={{color:"black"}}>usememo:</b>The React useMemo Hook returns a memoized value.
Think of memoization as caching a value so that it does not need to be recalculated.
The useMemo Hook only runs when one of its dependencies update.
This can improve performance.
<b style={{color:"black"}}>useCallback:</b>The React useCallback Hook returns a memoized callback function.
Think of memoization as caching a value so that it does not need to be recalculated.
...
<p><b style={{color:"black"}}>5.Why do we need keys in react?</b></p>
...
<p><b style={{color:"black"}}>6.Do you know about redux</b></p>
